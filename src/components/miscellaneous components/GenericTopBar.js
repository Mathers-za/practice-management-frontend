...
export default function GenericTopBar({
  ...
  return (
    <>
      <div
        className={` bg-sky-700  relative top-0 left-0 min-w-full min-h-fit p-3 font-serif text-lg text-white flex justify-between items-center select-none ${additionalClassName}`}
      >
